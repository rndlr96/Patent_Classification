...
class Model(object):
    ...
    def __init__(self, network, model_path, gradient_clip_value=5.0, device_ids=None, **kwargs):
        ...
        self.model = nn.DataParallel(network(**kwargs).to(device))
    ...
    def get_optimizer(self, **kwargs):
        ...
        #self.optimizer = torch.optim.Adam(filter(lambda p: p.requires_grad,self.model.parameters()), lr=0.001, weight_decay=4e-5)
